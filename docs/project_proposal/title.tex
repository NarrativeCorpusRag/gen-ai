...
\begin{titlepage}
	...
	\textsc{\LARGE Technische Universit\"{a}t Wien}\\[1.5cm]
	
	\textsc{\Large Plan for Generative AI Research Project}\\[0.5cm]
	
	\textsc{\large  194.207-2025W - Generative AI}\\[0.5cm]
...
% 	\@author % Your name
	...
	%------------------------------------------------
	\vfill\vfill
	\includegraphics[width=0.3\textwidth]{./TU-Logo-Austria_CMYK.png}
	\vfill
